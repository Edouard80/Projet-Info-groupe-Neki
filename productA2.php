		...
		<div class="row">
			<div class="col-md-6">
				<ol class="breadcrumb">
					...
					<li><a href="shop2.php">Adidas</a></li>
					<li class="active">NMD_R1 Primeblue</li>
				</ol>
			</div>
			<div class="col-md-6">
				<ol class="product-pagination text-right">
					<li><a href="productA1.php"><i class="tf-ion-ios-arrow-left"></i> Before </a></li>
					<li><a href="productA3.php">Next <i class="tf-ion-ios-arrow-right"></i></a></li>
				</ol>
			</div>
		</div>
		<div class="row mt-20">
					...
					<div id='carousel-custom' class='carousel slide' data-ride='carousel'>
						<div class='carousel-outer'>
							...
							<div class='carousel-inner '>
								<div class='item active'>
									<img src='images/shop/products/adidas2/1.jpeg' alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/adidas2/2.jpeg' alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/adidas2/3.jpeg' alt='' data-zoom-image="images/shop/single-products/product-2.jpg" />
								</div>
								
								<div class='item'>
									<img src='images/shop/products/adidas2/4.jpeg' alt='' data-zoom-image="images/shop/single-products/product-3.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/adidas2/5.jpeg' alt='' data-zoom-image="images/shop/single-products/product-4.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/adidas2/6.jpeg' alt='' data-zoom-image="images/shop/single-products/product-5.jpg" />
								</div>
						...
						<ol class='carousel-indicators mCustomScrollbar meartlab'>
							<li data-target='#carousel-custom' data-slide-to='0'class='active'>
								<img src='images/shop/products/adidas2/1.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='1' >
								<img src='images/shop/products/adidas2/2.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='2'>
								<img src='images/shop/products/adidas2/3.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='3'>
								<img src='images/shop/products/adidas2/4.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='4'>
								<img src='images/shop/products/adidas2/5.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='5'>
								<img src='images/shop/products/adidas2/6.jpeg' alt='' />
							</li>
						</ol>
					</div>
				</div>
