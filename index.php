			...
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="product-single.php">Air Jordan 1 Mid</a></h4>
	  ...
	  <div class="block text-center">
          <form action="inscription_traitementN.php" method="post"> 
            ...
            <div class="form-group">
                <input type="text" name="email" class="form-control" placeholder="Entrez votre email ici" required="required" autocomplete="off">
            </div>
            <div class="form-group">
