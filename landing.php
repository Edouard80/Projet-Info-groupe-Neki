					...
					<li class="dropdown full-width dropdown-slide">
						...
						<div class="dropdown-menu">
							<div class="row">
								...
								<div class="col-sm-3 col-xs-12">
									<ul>
										<li class="dropdown-header">Votre Profil</li>
										<li role="separator" class="divider"></li>
										<li><a href="dashboard.html">Profil</a></li>
										<li><a href="order.html">Vos commandes</a></li>
									</ul>
								</div>
...
<div class="hero-slider">
  <div class="slider-item th-fullpage hero-area" style="background-image: url(https://s.alicdn.com/@sc04/kf/H6b2e5e3aee2745fdbe7f08cbccd7e79e4.jpg);">
    <div class="container">
      <div class="row">
        <div class="col-lg-8 text-center">
          <p data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".1">PRODUITS</p>
          <h1 data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".5">A chaque pied <br> Son soulier.</h1>
          <a data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".8" class="btn" href="shop.php">Achetez <br/> maintenant</a>
        </div>
      </div>
    </div>
  </div>
  <div class="slider-item th-fullpage hero-area" style="background-image: url(https://media.gqmagazine.fr/photos/5e4bcbc7f5b87500083a8c45/master/pass/Air-Jordan-1-HIgh-OG-Dior.jpg);">
    <div class="container">
      <div class="row">
  ...
  <div class="slider-item th-fullpage hero-area" style="background-image: url(https://wibes-store.com/wp-content/uploads/2020/03/oscar-gutierrez-pldh-ckJbiI-unsplash-scaled-e1591183605513-450x414.jpg);">
    <div class="container">
      <div class="row">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="category-box">
					<a href="shop.php">
						<img src="images/shop/category/c3nike.png" alt="" />
						<div class="content">
							<h3>Nike</h3>
							<p>JUST DO IT</p>
						</div>
			...
			<div class="col-md-6">
				...
				<div class="category-box">
					<a href="shop2.php">
						<img src="images/shop/category/c2 adidas.jpg" alt="" />
						<div class="content">
							<h3>Adidas</h3>
							<p>ADIDAS IS ALL IN</p>
						</div>
					</a>	
				</div>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="product-single.html">Air Jordan 1 Mid</a></h4>
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						...
						<div class="preview-meta">
							<ul>
								<li>
									<li>
										<a href="product-single2.html" ><i class="tf-ion-ios-search-strong"></i></a>
									</li>
								</li>
								<li>
			                        <a href="#" ><i class="tf-ion-ios-heart"></i></a>
					...
					<div class="product-content">
						<h4><a href="product-single2.html">Air force 1 '07</a></h4>
						<p class="price">80€</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						...
						<div class="preview-meta">
							<ul>
								<li>
									<li>
										<a href="product-single3.html" ><i class="tf-ion-ios-search-strong"></i></a>
									</li>
								</li>
								<li>
			                        <a href="#" ><i class="tf-ion-ios-heart"></i></a>
					...
					<div class="product-content">
						<h4><a href="product-single3.html">Air force 1 Fontanka</a></h4>
						<p class="price">109,99€</p>
					</div>
				</div>
			</div>
...
?>
    <div class="row">
	  ...
	  <a class="logo" href="index.html">
          ...
          <form action="inscription_traitementN.php" method="post"> 
			<div class="title">
					<h2>Abonnez-vous</h2>
					<p>Ne manquez aucune nouveautés <br/> Rejoignez l'équipe Neki</p>
				</div>      
