		...
		<div class="row">
			<div class="col-md-6">
				<ol class="breadcrumb">
					...
					<li><a href="shop2.php">Adidas</a></li>
					<li class="active">Astir</li>
				</ol>
			</div>
			<div class="col-md-6">
				<ol class="product-pagination text-right">
					<li><a href="productA6.php"><i class="tf-ion-ios-arrow-left"></i> Before </a></li>
					<li><a href="productA8.php">Next <i class="tf-ion-ios-arrow-right"></i></a></li>
				</ol>
			</div>
		</div>
		<div class="row mt-20">
					...
					<div id='carousel-custom' class='carousel slide' data-ride='carousel'>
						<div class='carousel-outer'>
							...
							<div class='carousel-inner '>
								<div class='item active'>
									<img src='images/shop/products/adidas7/1.jpeg' alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/adidas7/2.jpeg' alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/adidas7/3.jpeg' alt='' data-zoom-image="images/shop/single-products/product-2.jpg" />
								</div>
								
								<div class='item'>
									<img src='images/shop/products/adidas7/4.jpeg' alt='' data-zoom-image="images/shop/single-products/product-3.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/adidas7/5.jpeg' alt='' data-zoom-image="images/shop/single-products/product-4.jpg" />
								</div>
								<div class='item'>
									<img src='images/shop/products/adidas7/6.jpeg' alt='' data-zoom-image="images/shop/single-products/product-5.jpg" />
								</div>
						...
						<ol class='carousel-indicators mCustomScrollbar meartlab'>
							<li data-target='#carousel-custom' data-slide-to='0'class='active'>
								<img src='images/shop/products/adidas7/1.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='1' >
								<img src='images/shop/products/adidas7/2.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='2'>
								<img src='images/shop/products/adidas7/3.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='3'>
								<img src='images/shop/products/adidas7/4.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='4'>
								<img src='images/shop/products/adidas7/5.jpeg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='5'>
								<img src='images/shop/products/adidas7/6.jpeg' alt='' />
							</li>
						</ol>
					</div>
				</div>
			...
			<div class="col-md-7">
				<div class="single-product-details">
					...
					<p class="product-description mt-20">
						Revendique ton style. Ne laisse personne aller à l'encontre de ta créativité. Remix d'une runner des années 2000, cette chaussure adidas Astir est faite pour s'exprimer. Confectionnée dans un mix ton sur ton de matières, elle possède des œillets surdimensionnés pour un look chic. Porte-la partout et avec tout, et partage ton originalité avec le monde entier
					</p>
